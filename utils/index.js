...
export function checkLotteryResultForSSQDLT(lotteryType, recordNumStr, winNumStr) {
  ...
  if (lotteryType === 1 || lotteryType === '1') {
    ...
    } else if ((frontMatchCount === 5 && backMatchCount === 0) || (frontMatchCount === 4 && backMatchCount === 2)) {
      result.prizeLevel = 3;
    ...
    } else if ((frontMatchCount === 4 && backMatchCount === 0) || (frontMatchCount === 3 && backMatchCount === 2)) {
      result.prizeLevel = 5;
  ...
  if (lotteryType === 2 || lotteryType === '2') {
...
function getLotteryNumberByTypeZone(group, needCount, sortOrder, dayOfYear) {
  ...
  const sortedGroup = [...group].sort((a, b) =>
    sortOrder === 'desc' ? b.occurrenceCount - a.occurrenceCount : a.occurrenceCount - b.occurrenceCount
  );
