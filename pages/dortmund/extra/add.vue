	...
	<view class="fx67ll-form-box">
		<uni-forms ref="form" :model="formParams" labelWidth="80px">
			...
			<uni-forms-item label="当前本金" name="seedMoney" required>
				<uni-easyinput v-model="formParams.seedMoney" placeholder="请输入当前本金"
					@input="handleSeedMoneyChangeDubounce" clearable />
			</uni-forms-item>
			...
			<uni-forms-item label="盈亏金额" name="winMoney" required>
				<uni-easyinput v-model="formParams.winMoney" placeholder="请输入外快盈亏金额" disabled />
			</uni-forms-item>
