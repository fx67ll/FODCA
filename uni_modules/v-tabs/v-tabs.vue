<template>
  <view :id="elId" class="v-tabs" v-if="isShowTabNow">
    <scroll-view
      id="scrollContainer"
      :scroll-x="scroll"
 ...
 * @property {String} activeColor = '#2ecc71' 选中文字颜色
 ...
 * @property {String} lineColor = '#2ecc71' 下划线的颜色
 * @property {Number} lineScale = 0.5 下划线的宽度缩放比例
 * @property {String} lineRadius = '10rpx' 下划线圆角
 * @property {Boolean} pills = [true | false] 是否胶囊样式
 * @property {String} pillsColor = '#2ecc71' 胶囊背景色
 * @property {String} pillsBorderRadius = '10rpx' 胶囊圆角大小
 * @property {String} field 如果是对象，显示的键名
 * @property {Boolean} fixed = [true | false] 是否固定
 * @property {String} paddingItem = '0 22rpx' 选项的边距
 * @property {Boolean} lineAnimation = [true | false] 下划线是否有动画
 * @property {Boolean} isNeedHiddenBtn = [true | false] 是否需要隐藏当前tab的按钮
 * @property {Boolean} isShowTabNow = [true | false] 当前是否显示tab
 *
